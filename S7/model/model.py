...
class CIFRModel(BaseModel):
    def __init__(self, num_classes=10, normalizationtype='Layer', dropout=.01):
        ...
        self.convblock3 = nn.Sequential(
            nn.ConvTranspose2d(in_channels=28, out_channels=128, kernel_size=(3, 3), padding=0, bias=False, dilation=8),
            nn.ReLU(),
            nn.Dropout(.10),
            nn.BatchNorm2d(128),
        ...
        self.convblock4 = nn.Sequential(
            nn.Conv2d(in_channels=128, out_channels=10, kernel_size=(3, 3), padding=0, bias=False, dilation=15),
            nn.ReLU()
