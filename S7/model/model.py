...
class CIFRModel(BaseModel):
        def __init__(self, num_classes=10, normalizationtype='Layer', dropout=.01):
            ...
            self.depthwise_separable_conv2 = nn.Sequential(
                nn.Conv2d(in_channels=128, out_channels=128, kernel_size=3, groups=128, padding=3, dilation=1,
                          bias=False),
                nn.BatchNorm2d(128),
                #nn.Dropout(.05),
                nn.ReLU(),
            ...
            self.convblock3 = nn.Sequential(
                nn.Conv2d(in_channels=32, out_channels=200, kernel_size=(3, 3), padding=1, bias=False, dilation=1),
                nn.BatchNorm2d(200),
                #nn.Dropout(.05),
                nn.ReLU(),
            ...
            self.convblock4 = nn.Sequential(
                nn.Conv2d(in_channels=200, out_channels=10, kernel_size=(3, 3), padding=0, bias=False, dilation=12),
                nn.ReLU()
