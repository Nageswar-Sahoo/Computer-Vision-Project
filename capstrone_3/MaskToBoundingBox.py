...
def build_coc_json(data, json_file):
    ...
    for mask_path in data:
        ...
        for num_label_idx in range(1, num_labels):
            ...
            # output_dict['labels'].append(cat[re.split('(\d+)', mask_path)[-1].split(".")[0]])
            ...
            ann = {
                ...
                "id": bnd_id,
                "ignore": 0,
                "area": abs(int((bbox[2] - bbox[0]) * (bbox[3] - bbox[1]))),
...
if __name__ == '__main__':
    ...
    build_coc_json(train_data, "instances_train20178.json")
    build_coc_json(test_data, "instances_val20178.json")